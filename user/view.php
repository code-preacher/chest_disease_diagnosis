...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="add-diagnose.php" method="POST">
                                       <div class="row p-t-20">
                                        ...
                                        <div class="col-md-6">
                                          <div class="form-group">
                                            <label class="control-label">Fatique:</label>
                                    ...
                                    <div class="col-md-6">
                                      <div class="form-group">
                                        <label class="control-label">Breathing Difficulties:</label>
                                ...
                                <!--/span-->
                                 ...
                                 <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="control-label">Stomach Pain:</label>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group">
                                    <label class="control-label">Running Nose/Vomiting:</label>
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label class="control-label">Tightness in Chest:</label>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label class="control-label">Muscle Pain:</label>
