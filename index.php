...
<head>
    ...
    <title>CHEST DISEASE DIAGNOSTIC SYSTEM!</title>
                ...
                <div class="container">
                    <div class="navbar-header pull-left">
                        <a class="navbar-brand page-scroll" href="#page-top">
                            ...
                            <span class="brand-logo">CHEST DISEASE DIAGNOSTIC SYSTEM</span>
                        </a>
                    </div>
            ...
            <header id="intro-carousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        ...
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown">Welcome to CHEST DISEASE DIAGNOSTIC SYSTEM! </h1>
                    ...
                    <div class="item">
                        ...
                        <div class="carousel-caption">
                            <h1 class="wow animated slideInDown">Diagnose your chest </span> </h1>
                ...
                <div class="mouse"></div>
                            ...
                            <div class="col-md-12 text-center">
                                &copy; 2021.CHEST DISEASE DIAGNOSTIC SYSTEM! All rights reserved.
                            </div><!-- /.col-md-12 -->
