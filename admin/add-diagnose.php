                                     ...
                                     <div class="row p-t-20">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f1" value="1" >Cough: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f2" value="1" >Fatique: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f3" value="1" >Breathing Difficulties: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f4" value="1" >Stomach Pain: </label>
                                                     </div>
                                            </div>
                                             ...
                                             <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f5" value="1" >Running Nose/ Vomiting: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f6" value="1" >Tightness in Chest: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f7" value="1" >Chest Pain: </label>
                                                     </div>
                                            </div>
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    ...
                                                    <label class="control-label">
                                                        <input type="checkbox" class="" name="f8" value="1" >Muscle Pain: </label>
                                                     </div>
                                            </div>
